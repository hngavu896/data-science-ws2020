...
Ich würde alle Namen der Autoren in einheitlichen Format schreiben. 
...
Auch diese Frage zu beantworten, nutze ich neue Tabelle mit bereinigten Daten (author_correct)
```{r}
